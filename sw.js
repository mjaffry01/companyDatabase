const CACHE_NAME = 'company-contact-book-v18-opportunity-ai';
const APP_SHELL = ['./', './index.html', './manifest.json', './opportunities.js', './opportunities.css', './profile.js', './compare.js', './career-urls.json'];
